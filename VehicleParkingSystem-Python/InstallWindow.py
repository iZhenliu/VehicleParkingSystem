...
class InstallWindow(QWidget):
    def __init__(self):
        ...
        label_no_of_two_seater=QLabel("No of Motorcycle Space : ")
        label_no_of_two_seater.setStyleSheet("color:#000;padding:8px 0px;font-size:18px;")
        label_no_of_four_seater=QLabel("No. of Car Space : ")
    ...
    def showStepInfo(self):
        ...
        if self.input_two_wheeler.text()=="":
            self.error_label.setText("Please Enter Motorcycle Space")
            return

        if self.input_four_wheeler.text()=="":
            self.error_label.setText("Please Enter Car Space")
            return
